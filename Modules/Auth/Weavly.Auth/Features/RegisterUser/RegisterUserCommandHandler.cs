...
public sealed class RegisterUserCommandHandler(AuthDbContext dbContext, PasswordHasher<AppUser> hasher, IMessageBus bus)
    : IWeavlyCommandHandler<RegisterUserCommand, Result>
{
